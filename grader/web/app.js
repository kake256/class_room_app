...
// ランキング下のサブタブ(点数内訳 / 最高点者)を切り替える。
const RANKING_SUBPANELS={breakdown:"subpanel-breakdown",top:"subpanel-top"};
